...
import { POST_DATA } from 'shared/constants/ActionTypes';

export default function AppForm({formName, children, title,id, loading, labelCol = 8,
  wrapperCol = 16,
  controller,
  action=POST_DATA,
  otherValues=null,
    ...
    useEffect(async()=>{
      if(id){
        ...
        if(data.statusCode === 200){
          formName.setFieldsValue(data.data)
        }
      }
      else{
